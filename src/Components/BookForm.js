...
const BookForm=(props) => {
    ...
    const ok = () => {
        ...
        if (title == "" || author == "" || pages == -1) {
            ...
            fetch('http://localhost:5000/all-saints-reading-club/us-central1/student-createBook?userid=' + props.userid + '&title=' + title + '&author=' + author + '&pages=' + pages + '&q1=' + q1 + '&q2=' + q2 + '&q3=' + q3 + '&a1=' + a1 + '&a2=' + a2 + '&a3=' + a3)
            .then(response => console.log("Created book?", response))
            .catch((error) => {
                console.error('Error:', error.message);
            });      

            fetch('http://localhost:5000/all-saints-reading-club/us-central1/student-increaseBook?userid=' + props.userid + '&num=' + props.booksNum)
